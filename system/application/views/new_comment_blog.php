		...
		<tr>
			<td class="Dialog Message">
				<table class="CommentsNewComments">
					<tr>
						<td colspan="2">
							<form method="POST" action="/comments/new_comment_blog/">
							<textarea rows="2" name="comment" cols="20" class="CommentsTextBox"><?php echo $this->validation->comment;?></textarea>
							<input type="hidden" name="blog_id" value="{blog_id}<?php echo $this->validation->blog_id;?>" />
						</td>
					</tr>
					<tr>
						<td>
				...
				<?php echo $this->validation->blog_id_error;?>
			</td>
		</tr>
	</table>
</div>